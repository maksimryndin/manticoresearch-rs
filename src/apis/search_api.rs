...
pub async fn percolate(configuration: &configuration::Configuration, index: &str, percolate_request: crate::models::PercolateRequest) -> Result<crate::models::SearchResponse, Error<PercolateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/pq/{index}/search", local_var_configuration.base_path, index=crate::apis::urlencode(index));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PercolateError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn search(configuration: &configuration::Configuration, search_request: crate::models::SearchRequest) -> Result<crate::models::SearchResponse, Error<SearchError>> {
    let local_var_configuration = configuration;
